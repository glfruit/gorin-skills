...
```bash
test -f .openclaw/skills-config/baoyu/baoyu-cover-image/EXTEND.md && echo "project"
test -f "$HOME/.openclaw/skills-config/baoyu/baoyu-cover-image/EXTEND.md" && echo "user"
```
