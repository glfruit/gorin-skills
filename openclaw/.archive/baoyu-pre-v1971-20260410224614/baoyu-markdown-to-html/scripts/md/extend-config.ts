...
function getConfigPaths(): string[] {
  ...
  const home = homedir();
  return [
    path.join(cwd, ".openclaw", "skills-config", "baoyu", "baoyu-markdown-to-html", "EXTEND.md"),
    path.join(home, ".openclaw", "skills-config", "baoyu", "baoyu-markdown-to-html", "EXTEND.md"),
    path.join(cwd, ".baoyu-skills", "baoyu-markdown-to-html", "EXTEND.md"),
    path.join(home, ".baoyu-skills", "baoyu-markdown-to-html", "EXTEND.md"),
  ];
}
