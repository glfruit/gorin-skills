...
options:
  - label: "Project (Recommended)"
    description: ".openclaw/skills-config/baoyu/ (this project only)"
  - label: "User"
    description: "~/.openclaw/skills-config/baoyu/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.openclaw/skills-config/baoyu/baoyu-image-gen/EXTEND.md` | Current project |
| User | `$HOME/.openclaw/skills-config/baoyu/baoyu-image-gen/EXTEND.md` | All projects |
