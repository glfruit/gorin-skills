...
test -f .openclaw/skills-config/baoyu/baoyu-comic/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.openclaw/skills-config/baoyu/baoyu-comic/EXTEND.md" && echo "user"
```

| Path | Location |
|------|----------|
| `.openclaw/skills-config/baoyu/baoyu-comic/EXTEND.md` | Project directory |
