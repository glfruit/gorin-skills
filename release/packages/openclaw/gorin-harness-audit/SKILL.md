---
name: gorin-harness-audit
description: Reviewer-type skill for auditing OpenClaw agent harness
  configuration health. Scans SOUL.md, AGENTS.md, SKILL.md, and cron jobs across
  all agent workspaces for bloat, stale references, rule duplication, and
  hard-coded payloads. Outputs severity-classified findings (P0-P3) with trend
  tracking across audits. Do NOT use for code review (use code-review skill) or
  host security (use healthcheck).
license: MIT
---
