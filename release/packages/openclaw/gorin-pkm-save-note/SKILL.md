---
name: gorin-pkm-save-note
description: 通用笔记保存接口（非文献、非想法）。支持
  insight/decision/summary/meeting/plan/review/moc/fleeting。由 zk-router 路由调用。
license: MIT
user-invocable: false
command-dispatch: tool
metadata: {"openclaw":{"requires":{"skills":["gorin-pkm-core","obsidian-md"],"used-by":["gorin-zk-router"]}}}
---
