---
name: gorin-edu-xlsx
description: "Edu outline Excel operations: identify, read, edit, validate, and
  extract from textbook/course/training .xlsx outline files. Do not use for
  general spreadsheet tasks — use xlsx skill instead. Not for Word docs or
  PowerPoint."
license: MIT
homepage: "https://github.com/glfruit/gorin-skills/tree/main/skills/education/gorin-edu-xlsx"
user-invocable: true
---

# gorin-edu-xlsx — 教育大纲 Excel 操作
...
❌ 通用 Excel 操作 → `xlsx` 技能 | 非 Excel 大纲 → 直接 Markdown | PPT 课件 → `gorin-edu-pptx`
