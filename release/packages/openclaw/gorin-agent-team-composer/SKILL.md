---
name: gorin-agent-team-composer
description: 从自然语言团队需求生成 OpenClaw 多智能体团队脚手架，包括 SOUL.md、AGENTS.md、协作规则和 YAML
  配置。Do NOT use for single-agent creation or modifying existing team configs.
license: MIT
---
