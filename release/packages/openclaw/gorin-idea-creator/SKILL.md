---
name: gorin-idea-creator
description: 创建和管理想法笔记，自动发现关系。使用 '想法 xxx' 或 '/pkm_idea' 触发。依赖 pkm-core
  进行智能分类和关系发现。Do NOT use for general notes or literature excerpts.
license: MIT
user-invocable: true
command-dispatch: tool
metadata: {"openclaw":{"requires":{"skills":["gorin-pkm-core"],"used-by":["gorin-zk-router"]}}}
---
