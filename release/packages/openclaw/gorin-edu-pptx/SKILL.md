...
name: gorin-edu-pptx
description: >
  教学课件 PPT 生成与编辑的统一入口。从零创建用 PptxGenJS，编辑已有 PPT 用 OfficeCLI， 对外展示类可选用
  banana-slides。支持教学主题系统和视觉 QA 流程。
license: MIT
homepage: "https://github.com/glfruit/gorin-skills/tree/main/skills/education/gorin-edu-pptx"
---

# gorin-edu-pptx — 教学课件 PPT 技能
