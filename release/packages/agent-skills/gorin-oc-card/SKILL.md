---
name: gorin-oc-card
description: OpenClaw-native router for ambiguous card-format requests. Use when
  the user says '做成图', '做成卡片', '转成视觉卡片', 'long card', or wants help choosing a
  visual card format from source material. Don't use it for summarization, prose
  cleanup, publishing, tabular conversion, or when the user already named a
  specific downstream visual generator.
license: MIT
---
