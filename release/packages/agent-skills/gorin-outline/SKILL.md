---
name: gorin-outline
description: "Manage Outline knowledge base — create/read/search/update/delete
  documents and collections. Use when the user asks to create wiki pages, search
  knowledge base, manage collections, organize team docs, share documents, or
  batch import content to Outline. Triggers: 'outline', '知识库', 'wiki',
  'collection', '创建文档 outline', '搜索知识库'. Do NOT use for editing .docx files (use
  superdoc skill) or PDFs (use pdf skill)."
license: MIT
---
