---
name: gorin-safe-mode
description: Session-scoped safety modes for destructive or sensitive
  operations. Activate via /careful, /freeze, or /dry-run keywords. Do NOT use
  for routine operations or read-only tasks.
license: MIT
---
