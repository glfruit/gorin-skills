---
name: gorin-bearclaw-native
description: Rock-solid Bear Blog publishing using OpenClaw's native browser (no
  Chrome extension needed). Do NOT use for reading Bear notes or non-Bear-Blog
  platforms.
license: MIT
---
