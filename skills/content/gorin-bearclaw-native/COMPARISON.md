...
# 2. 安装 skill
node scripts/gorin-skills.mjs install --skill gorin-bearclaw-native --target openclaw --home "$HOME"
...
node scripts/gorin-skills.mjs uninstall --skill gorin-bearclaw-native --target openclaw --home "$HOME"
```
