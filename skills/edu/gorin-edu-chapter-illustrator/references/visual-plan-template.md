...
| ID | Source Section | figure_type | engine | generator_route | generation_backend | generation_evidence_path | engine_reason | Learning Purpose | Placeholder | Caption | Source/Prompt/Target | Asset Path | QA |
|----|----------------|-------------|--------|-----------------|--------------------|--------------------------|---------------|------------------|-------------|---------|----------------------|------------|----|
| fig-00-01 | | workflow/framework/data_model/concept_illustration/reference_qr | mermaid/svg/html_svg/ai_image/qr | mermaid_cli/html_svg_renderer/openclaw_native_image/qr_generator | concrete renderer/script/approved gorin-* skill | `assets/figures/qa/fig-00-01-generation.md` | Why this engine is allowed for this figure type | | `{{FIG:fig-00-01}}` | 图 0-1 ... | `assets/figures/source/fig-00-01.mmd` or `assets/figures/prompts/fig-00-01.md` or `target_url`/`target_status` | `assets/figures/generated/fig-00-01.png` | pending |
...
- Every visual must have policy-compliant `figure_type`, `engine`,
  `generator_route`, `generation_backend`, and `generation_evidence_path`.
